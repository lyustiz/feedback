...
import tipoSubscripcionForm  from './tipoSuscripcionForm';
export default {
    mixins:     [ listHelper],
    components: { 'tipo-subscripcion-form': tipoSubscripcionForm },
    data () {
    return {
        title:    'TipoSubscripcion',
        resource: 'tipoSubscripcion',
        headers: [
            { text: 'Tipo Subscripcion',   value: 'nb_tipo_subscripcion' },
