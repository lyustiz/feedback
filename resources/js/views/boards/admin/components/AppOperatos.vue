          ...
          <v-list-item-content>
            <v-list-item-title>
              <v-row no-gutters>
                  <v-col cols="auto">
                    ...
                    <template v-slot:activator="{ on, attrs }">
                      <span v-on="on" v-bind="attrs">{{ operator.presence_day_sum_profit || 0 }}  /  {{ operator.goal_day || 0 }}</span>
                    </template>
                    <span>Meta Dia</span>
                    </v-tooltip>
                  </v-col>
                  ...
                  <v-col cols="auto">
                    ...
                    <template v-slot:activator="{ on, attrs }">
                      <span v-on="on" v-bind="attrs">{{ operator.presence_month_sum_profit || 0 }}  /  {{ operator.goal_month || 0 }}</span>
                    </template>
                    <span>Meta Mes</span>
                    </v-tooltip>
                  </v-col>
              ...
              <v-row no-gutters>
                  <v-col>
                    <v-progress-linear
                    :value="operator.presence_day_sum_profit*100/operator.goal_day || 0"
                    color="blue"
                    height="8"
                    class="mb-2 mt-1"
                    ></v-progress-linear>
                  ...
                  <v-col>
                    <v-progress-linear
                    :value="operator.presence_month_sum_profit*100/operator.goal_month || 0"
                    color="green"
                    height="8"
                    class="mb-2 mt-1"
                    ></v-progress-linear>
